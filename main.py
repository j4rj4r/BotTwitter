...
BlackListCompte = ["gulzaarAvi","NistikConcours","WqveConcours","FlawyxC","Linyz_V1","FortniteVenox","TidaGameuse","YeastLeaks","CrashqConcours","Yanteh_","NistiKTV","BotSpotterBot","b0ttem","RealB0tSpotter","jflessauSpam"]#Blacklist pour compte à concours (très) bidon | Il faut metre le pseudo après le @
